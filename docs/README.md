...
| [PROPWASH_AND_DTERM_DIAGNOSTICS](./PROPWASH_AND_DTERM_DIAGNOSTICS.md) | **Active** | — | ~~Prop wash event detection~~ (done) + D-term noise-to-effectiveness ratio diagnostics |
