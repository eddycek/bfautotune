...
| [COMPREHENSIVE_TESTING_PLAN](./COMPREHENSIVE_TESTING_PLAN.md) | **Complete** | #84–#88 | 9-phase testing plan: 1665 tests / 89 files |
...
| [TUNING_PRECISION_IMPROVEMENTS](./TUNING_PRECISION_IMPROVEMENTS.md) | **Active** | #119 | Research-based tuning accuracy improvements: Wiener deconvolution, throttle spectrograms, proportional PID scaling, ~~data quality scoring~~ (done), chirp analysis |
