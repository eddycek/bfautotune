...
**Total: 1895 unit tests across 96 files + 16 Playwright E2E tests** (last verified: February 28, 2026)
...
| `analysis/StepMetrics.test.ts` | 38 | Rise time, overshoot, settling, latency, ringing, FF contribution classification, trackingErrorRMS computation and aggregation, adaptive response window (quad-size variants, clamping, fallback) |
