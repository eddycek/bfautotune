...
**Total: 1893 unit tests across 96 files + 16 Playwright E2E tests** (last verified: February 28, 2026)
...
| `analysis/StepMetrics.test.ts` | 29 | Rise time, overshoot, settling, latency, ringing, energy-based FF contribution ratio, trackingErrorRMS computation and aggregation |
| `analysis/PIDRecommender.test.ts` | 44 | Flight PID anchoring, convergence, safety bounds, FF context, continuous FF ratio recommendations (dominated/mixed/PID), flight style thresholds, proportional severity scaling |
