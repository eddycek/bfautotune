...
**Total: 1906 unit tests across 97 files + 16 Playwright E2E tests** (last verified: March 1, 2026)
...
| `analysis/PIDAnalyzer.test.ts` | 20 | End-to-end pipeline, progress reporting, FF context wiring, flight style propagation, data quality scoring, prop wash integration |
| `analysis/PropWashDetector.test.ts` | 15 | Throttle drop detection (ramp/constant/multi-event/short spike), prop wash analysis (severity, frequency, worst axis, per-axis energy, BF raw throttle) |
