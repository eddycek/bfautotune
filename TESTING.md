...
**Total: 1914 unit tests across 97 files + 16 Playwright E2E tests** (last verified: March 1, 2026)
...
| `analysis/ChirpAnalyzer.test.ts` | 27 | Chirp detection (header/pattern), cross-spectral transfer function, coherence, Bode metrics, integration |
| `analysis/PIDAnalyzer.test.ts` | 22 | End-to-end pipeline, progress reporting, FF context wiring, flight style propagation, data quality scoring, chirp analysis integration |
