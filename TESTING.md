...
**Total: 1910 unit tests across 97 files + 16 Playwright E2E tests** (last verified: March 1, 2026)
...
| `analysis/BayesianOptimizer.test.ts` | 23 | Objective function, observation extraction, Cholesky decomposition, GP optimization, history-based multi-axis optimization |
| `analysis/PIDAnalyzer.test.ts` | 22 | End-to-end pipeline, progress reporting, FF context wiring, flight style propagation, data quality scoring, Bayesian optimization integration |
