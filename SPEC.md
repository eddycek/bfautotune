...
| `analysis-pid` | step response extraction, scoring, recommendations | :white_check_mark: | `src/main/analysis/` — 5 modules, 113 tests (flight PID anchoring, convergent, FF-aware, data quality scoring, prop wash detection) |
...
| Keep core algorithms pure and testable (input → output) | :white_check_mark: | All analysis modules: pure TypeScript, no side effects, 343 tests (151 filter + 138 PID + 22 data quality + 27 header validation + 5 misc) |
...
**Last Updated:** March 1, 2026 | **Tests:** 1906 unit tests across 97 files + 16 Playwright E2E tests | **PRs Merged:** #1–#137
