...
| `analysis-filter` | FFT, noise floor, peaks, filter recommendations | :white_check_mark: | `src/main/analysis/` — 6 modules, 152 tests (convergent noise-based targets, RPM-aware, data quality scoring, group delay estimation) |
...
| Keep core algorithms pure and testable (input → output) | :white_check_mark: | All analysis modules: pure TypeScript, no side effects, 350 tests (174 filter + 122 PID + 22 data quality + 27 header validation + 5 misc) |
...
**Last Updated:** March 1, 2026 | **Tests:** 1913 unit tests across 97 files + 16 Playwright E2E tests | **PRs Merged:** #1–#137
