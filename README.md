...
**Unit tests:** 1905 tests across 97 files — MSP protocol, storage managers, IPC handlers, UI components, hooks, BBL parser fuzz, analysis pipeline validation, E2E workflows.
...
│   │   │   ├── CrossAxisDetector.ts # Cross-axis coupling detection (correlation)
