...
**Unit tests:** 1904 tests across 97 files — MSP protocol, storage managers, IPC handlers, UI components, hooks, BBL parser fuzz, analysis pipeline validation, E2E workflows.
...
│   │   │   ├── TransferFunctionEstimator.ts # Wiener deconvolution (Bode plot)
