...
- **CrossAxisDetector**: Normalized Pearson correlation between gyro axes during step events, coupling severity classification (none/mild/significant)
- **PIDAnalyzer**: Orchestrator with async progress reporting, threads `flightPIDs` through pipeline, cross-axis coupling detection
