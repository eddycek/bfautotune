 ...
 *
 * Wipes the demo state, then clicks through 5 full tuning cycles
 * (filter + PID, skipping verification) to populate tuning history
 * with progressive quality scores.
 *
