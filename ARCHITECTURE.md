...
**Last Updated:** March 1, 2026 | **Phase 4 Complete, Phase 6 Complete** | **1913 unit tests, 97 files + 16 Playwright E2E tests**
...
| `FilterAnalyzer.ts` | 212 | 17 | Filter analysis orchestrator (data quality integration, group delay) |
| `GroupDelayEstimator.ts` | 202 | 22 | Filter chain group delay estimation (PT1, biquad, notch) |
...
**1913 unit tests across 97 files + 16 Playwright E2E tests**. See [TESTING.md](./TESTING.md) for complete inventory.

| Area | Files | Tests |
|------|-------|-------|
| Blackbox Parser | 9 | 245 |
| FFT Analysis (+ Data Quality) | 7 | 174 |
