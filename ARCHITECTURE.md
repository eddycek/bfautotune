...
**Last Updated:** February 28, 2026 | **Phase 4 Complete, Phase 6 Complete** | **1891 unit tests, 96 files + 16 Playwright E2E tests**
...
| `FilterRecommender.ts` | 511 | 48 | Noise-based filter targets, RPM-aware bounds, propwash-aware floor |
...
**1891 unit tests across 96 files + 16 Playwright E2E tests**. See [TESTING.md](./TESTING.md) for complete inventory.

| Area | Files | Tests |
|------|-------|-------|
| Blackbox Parser | 9 | 245 |
| FFT Analysis (+ Data Quality) | 6 | 158 |
